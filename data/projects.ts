export const projects = [
  {
    ...
    longDesc:
      "Calmora is a mental health application UI designed using a user-centered design approach. The project explores user research, persona creation, wireframing, and interactive prototyping to address emotional well-being. The interface emphasizes calm color palettes, clear typography, and intuitive navigation to create a safe and comforting digital space. Through thoughtful design decisions, Calmora aims to reduce cognitive load and support users in managing their mental health more effectively.",
  ...
  },
  {
    ...
    longDesc:
      "Ling-Ling Pet Shop is a web-based system developed to support pet shop business operations and customer interaction. The project includes system planning (SKPL), database design, UI development, and backend implementation. The website enables users to browse products, access service information, and interact with the business efficiently. The system also supports structured data management, ensuring scalability and ease of maintenance for long-term business use.",
  ...
  },
  {
    ...
    longDesc:
      "WasteWise is a UI/UX design project aimed at simplifying digital waste management through an informative and accessible interface. The design process includes user research, wireframing, usability testing, and prototyping to present waste-related data clearly. By focusing on clarity and usability, WasteWise helps users understand environmental data and encourages responsible waste management behavior through digital solutions.",
  ...
  },
  {
    ...
    longDesc:
      "Dedikasi is a UI/UX design for UMKM owners to sell products and connect with investors. The design focuses on creating a supportive and accessible interface that encourages user engagement and trust. Through careful attention to user research, prototyping, and iterative design, Dedikasi aims to provide a seamless experience for both sellers and buyers.",
  ...
  },
  {
    ...
    longDesc:
      "Kelana is a travel application UI project that emphasizes intuitive navigation, visual storytelling, and user-centered design. The project includes user research, wireframing, and high-fidelity UI design to help users explore destinations, plan trips, and manage travel experiences. Through engaging visuals and structured layouts, Kelana enhances the overall travel planning experience while maintaining usability and clarity.",
  ...
  },
  {
    ...
    shortDesc:
      "A healthcare mobile application designed to help users check drug ingredients, access detailed medication information, receive medication reminders, and find nearby pharmacies.",
    longDesc:
      "Remedify is a healthcare mobile application focused on improving medication awareness and adherence. The app allows users to check drug ingredients, view detailed medication information including usage and precautions, receive timely reminders for taking medication, and locate nearby pharmacies based on their location. The design emphasizes clarity, accessibility, and ease of use to support users in managing their health safely and effectively.",
    tools: ["Dart", "Flutter", "API"],
  ...
  {
    id: 10,
    title: "Impact of Rainfall Changes on Yield",
